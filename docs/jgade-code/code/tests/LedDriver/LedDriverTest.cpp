...
#include "CppUTest/TestHarness.h" //<callout id="co.LedDriver.StartingPoint.TestHarness.h" />

extern "C"
{
#include "LedDriver.h" //<callout id="co.LedDriver.StartingPoint.LedDriver.h" />
}

TEST_GROUP(LedDriver) //<callout id="co.LedDriver.StartingPoint.TEST_GROUP" />
{
    void setup() //<callout id="co.LedDriver.StartingPoint.setup" />
    {
      LedDriver_Create();
    }

    void teardown() //<callout id="co.LedDriver.StartingPoint.teardown" />
    {
       LedDriver_Destroy();
    }
};
...
{
  FAIL("Start here");  //<callout id="co.LedDriver.StartingPoint.FAIL" />
}
//END: StartingPoint
...
TEST(LedDriver, LedsAreOffAfterInitialization)
{
