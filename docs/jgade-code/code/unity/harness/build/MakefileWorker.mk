...
#   UNITY_HOME - where CppUTest home dir found
...
ifeq ($(UNITY_USE_MEM_LEAK_DETECTION), N)
	...
	UNITY_MEMLEAK_DETECTOR_MALLOC_MACRO_FILE = -include $(UNITY_HOME)/include/unity_fixture_malloc_overrides.h
endif
...
gcov: test
	...
	$(UNITY_HOME)/scripts/filterGcov.sh $(GCOV_OUTPUT) $(GCOV_ERROR) $(GCOV_REPORT) $(TEST_OUTPUT)
