...
TEST(Keyboard2, test_read_all_buttons) 
{
    ...
    LONGS_EQUAL(1, real_all_buttons());
}
...
//     mock().expectOneCall("real_all_buttons").andReturnValue(keycode);
